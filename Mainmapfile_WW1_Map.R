...
ui <- fluidPage(
  ...
  dashboardPage(
    ...
    dashboardBody(
      tabItems(
        tabItem("Beskrivelseafudfordringer", div(p("A"))),
        tabItem("Hvordan_jeg_behandlede_dataen", div(p("B"))),
        tabItem("Overvejelser_og_Konklusion", div(p("C"))),
        tabItem("Link_til_original_data", div(p("D"))),
        tabItem("Kontakt_info", div(p("D"))),
        tabItem("Projektet", div(p("Dashboard tab content"))),
